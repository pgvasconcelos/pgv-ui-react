...
function App() {
  ...
  const authenticateWithPassword = async (savedPassword) => {
    try {
      const response = await axios.post('https://authentication.pgv.services/api/auth/login', { password: savedPassword }, { withCredentials: true });
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://authentication.pgv.services/api/auth/login', { password }, { withCredentials: true });
