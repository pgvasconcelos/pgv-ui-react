    ...
    return(
       <Reveal>
        <main className="flex  flex-col items-center justify-between ">
            ...
            <a href="/" className="flex w-full no-underline">
            ...
            <ReactMarkdown linkTarget="_blank" rel='noreferrer' className="pt-8 text-left">{work.attributes.content}</ReactMarkdown>
